            ...
            <div class="container">
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="#"><i class="fa fa-envelope-open-o f-s-14"></i> dolcesalato@gmail.com </a></li>
                        <li><a href="#"><i class="fa fa-phone f-s-14"></i> 997610443 </a></li>
						<li><a href="#"><i class="fa fa-whatsapp f-s-14"></i> 997610443 </a></li>	
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#">Siguenos en</a></li>
                        <li><a href="#"><i class="fa fa-facebook f-s-14"></i></a></li>
						<li><a href="#"><i class="fa fa-envelope-open-o f-s-14"></i></a></li>						
